...
public class ProviderController {
    ...
    @Autowired
    public ProviderController(ProviderRepository providerRepository, CreateProviderService createProviderService,
                              FindProvidersService findProvidersService, ModelMapper modelMapper) {
